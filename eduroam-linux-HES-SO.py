...
Messages.quit = "Voulez vous quitter la page ?"
Messages.username_prompt = "entrez votre identifiant d'utilisateur"
Messages.enter_password = "entrer le mot de passe"
Messages.enter_import_password = "entrez votre mot de passe " \
    "d'importation"
Messages.incorrect_password = "mot de passe incorrect"
Messages.repeat_password = "entrez à nouveau votre mot de passe"
Messages.passwords_differ = "les mots de passe ne correspondent pas"
Messages.installation_finished = "Installation réussie"
Messages.cat_dir_exisits = "Le répertoire {} existe; certains de ses " \
    "fichiers peuvent être écrasés."
Messages.cont = "Continuer ?"
Messages.nm_not_supported = "Cette version de NetworkManager n'est pas " \
    "supportée"
Messages.cert_error = "Fichier certificat non trouvé, cela semble une " \
    "erreur de CAT"
Messages.unknown_version = "Version inconnue"
Messages.dbus_error = "Problème de connexion DBus, un 'sudo' pourrait " \
    "aider"
Messages.yes = "Oui"
Messages.no = "Non"
Messages.p12_filter = "fichier de certificat personnel (p12 ou pfx)"
Messages.all_filter = "Tous les fichiers"
Messages.p12_title = "fichier de certificat personnel (p12 ou pfx)"
Messages.save_wpa_conf = "La configuration de NetworkManager a " \
    "échoué mais nous pouvons générer un fichier de configuration pour " \
    "wpa_supplicant si vous le souhaitez. Attention : votre mot de passe de " \
    "connexion sera sauvé en clair dans ce fichier."
Messages.save_wpa_confirm = "Écrire le fichier"
Messages.wrongUsernameFormat = "Erreur : votre nom d'utilisateur doit " \
    "être de la forme 'xxx@institutionID', par exemple  'john@exemple.net' " \
    "!"
Messages.wrong_realm = "Erreur : votre nom d'utilisateur doit être de " \
    "la forme 'xxx@{}'. Merci d'entrer le nom d'utilisateur dans le bon " \
    "format."
Messages.wrong_realm_suffix = "Erreur : votre nom d'utilisateur doit " \
    "être de la forme 'xxx@institutionID' et se terminer en '{}'. Merci " \
    "d'entrer le nom d'utilisateur dans le bon format."
Messages.user_cert_missing = "fichier de certificat personnel non " \
    "trouvé"
Config.instname = "HES-SO"
Config.profilename = "eduroam"
Config.url = "votre page de support local eduroam®"
...
Config.init_info = "Cet installateur a été préparé pour " \
    "{0}\n\nPlus d'informations et commentaires :\n\nEMAIL: {1}\nWWW: " \
    "{2}\n\nCet installateur a été conçu en partenariat avec RENATER " \
    "dans le cadre du projet pour le réseau européen de la recherche " \
    "GÉANT (www.geant.net)"
Config.init_confirmation = "Cet installateur ne fonctionnera " \
    "correctement que si vous êtes membre de {0}."
